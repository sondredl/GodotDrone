...
func _ready() -> void:
    ...
    _discard = battery_weight_slider.value_changed.connect(
        _on_battery_weight_changed)
    ...
    _discard = pitch_rate_slider.value_changed.connect(
        _on_rate_changed.bind(pitch_rate_slider))
    _discard = roll_rate_slider.value_changed.connect(
        _on_rate_changed.bind(roll_rate_slider))
    _discard = yaw_rate_slider.value_changed.connect(
        _on_rate_changed.bind(yaw_rate_slider))
    _discard = pitch_rc_slider.value_changed.connect(
        _on_rc_changed.bind(pitch_rc_slider))
    _discard = roll_rc_slider.value_changed.connect(
        _on_rc_changed.bind(roll_rc_slider))
    _discard = yaw_rc_slider.value_changed.connect(
        _on_rc_changed.bind(yaw_rc_slider))
    _discard = pitch_expo_slider.value_changed.connect(
        _on_expo_changed.bind(pitch_expo_slider))
    _discard = roll_expo_slider.value_changed.connect(
        _on_expo_changed.bind(roll_expo_slider))
    _discard = yaw_expo_slider.value_changed.connect(
        _on_expo_changed.bind(yaw_expo_slider))
