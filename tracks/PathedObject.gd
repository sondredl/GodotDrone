...
@export var spline_points := "": set = set_spline_points
@export var spacing := 1.0: set = set_spacing
func _ready() -> void:
    var _discard = connect("curve_changed", Callable(self, "_on_curve_changed"))
